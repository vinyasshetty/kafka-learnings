...
Now the object that we create from class which extends ConsumerRebalanceListener needs to be passed in the subscribe method.=&gt; \(com.example.viny.Consumer5\) 
