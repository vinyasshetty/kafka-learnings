...
* Avro is the only one supported in SchemaRegistry.Each message in Kafka needs to be independent and hence the benfit we ideally get Columnar format like Parquet/ORC is not valid in Kafka.
